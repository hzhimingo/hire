...
public class SMSUtils {
    ...
    private final TencentCloudResource tencentCloudResource;

    public SMSUtils(TencentCloudResource tencentCloudResource) {
        this.tencentCloudResource = tencentCloudResource;
    }
...
//            httpProfile.setReqMethod("POST"); // 默认使用POST
            ...
            req.setSignName("xxxxx");         // 签名
            req.setTemplateId("xxxxxx");       // 模板id：必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看
